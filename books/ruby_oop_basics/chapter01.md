...
language: 'ja'
unique_identifier:
 - 'http://melborne.github.com/books/20130207understand_ruby_object.html'
 - 'BookID'
 - 'URL'
title: 'オブジェクトの理解から始めるRuby'
subject: 'programming, ruby, オブジェクト指向, 入門'
description: '本書は、ブログ「hp12c」( http://melborne.github.com/ )における「オブジェクトの理解から始めるRuby」の電子書籍版です。Rubyのクラス、モジュール、オブジェクトを理解するための入門記事になっています。'
creator: 'kyoendo'
date: '2013-02-07'
...
![Alt title noshadow](images/ruby_class.png)
...
![ruby inheritance noshadow](images/ruby_inherit.png)
...
![Alt title noshadow](images/ruby_module.png)
...
![Alt title noshadow](images/ruby_singleton.png)
...
![Alt title noshadow](images/ruby_extend.png)
